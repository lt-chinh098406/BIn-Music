...
const app = {
  ...
  songs: [
    ...
    },
    {
      name: "người em cố đô",
      singer: "RUm",
      path: "./assets/music/Người Em Cố Đô - Rum x Đaa「Lo - Fi Version by 1 9 6 7」- Audio Lyrics.mp3",
      image: "./assets/img/5.jpg",
    },
    {
      name: "ôm trọn nỗi nhớ",
      singer: "RUM",
      path: "./assets/music/Ôm Trọn Nỗi Nhớ - Rum x Dứa「Lo - Fi Version by 1 9 6 7」- Official Video.mp3",
      image: "./assets/img/5.jpg",
    },
    {
      name: "Phố k em",
      singer: "Thai Dinh",
      path: "./assets/music/Phố Không Em - Thai Dinh - Official Audio - 2016.mp3",
      image: "./assets/img/5.jpg",
    },
    {
      name: "Thằng Điên",
    ...
    },
    {
      name: "Vùng Ký Ức",
      singer: "Chillies",
      path: "./assets/music/Vùng Ký Ức - Chillies (Official Music Video).mp3",
      image: "./assets/img/5.jpg",
    },
    {
      name: "Kẻ theo đuổi ánh sáng",
      singer: "Huy Vạc",
      path: "./assets/music/Nguyện làm chiếc bóng của người yêu thương... - KTDAS - Huy Vạc (lời Việt) - Lyrics Video.mp3",
      image: "./assets/img/5.jpg",
    },
    {
      name: "Vùng Ký Ức",
